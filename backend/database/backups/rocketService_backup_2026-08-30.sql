...
--
-- Servidor: localhost
-- Tiempo de generación: 31-08-2026 a las 05:29:19
...
(1, 'Lubricante', 'Aceites de motor, grasas y líquidos que aseguran el buen funcionamiento.', 1),
(2, 'Sistema electrico', 'Baterias, luces, sensores, cableado y sistema de encendido', 1),
(3, 'Filtracion', 'Filtros de aire, aceite y combustible elementos y carcasas asociadas', 1),
(4, 'sistema de frenos', 'Discos, pastillas, bombas y componentes del sistema de frenos.', 1),
(5, 'Suspencion', 'Amortiguadores, Horquillas, barras de suspencion, aceites de suspencion.', 1),
(6, 'Transmision', 'Cadenas, piñones, coronas, kits de arrastre, embragues, discos de cloche y cajas de cambios.', 1),
(7, 'Motor y partes', 'Pistones, anillos, \nválvulas, culatas, cilindros, cigüeñales y empaquetaduras (juntas).', 1),
(8, 'Carrocería y Chasis', 'Carenados, guardabarros, tanques de combustible, \nasientos, espejos, manillares y defensas.', 1),
(9, 'Ruedas y Llantas', 'Neumáticos, rines, llantas y válvulas.', 1),
(10, 'Instrumentación', 'Velocímetros, tacómetros e indicadores de combustible.', 1);
...
CREATE TABLE `clasificacion_de_usuarios` (
  ...
  `categoria_usuario` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `insumos` (`id_insumo`, `id_categoria`, `id_unidad`, `nombre_insumo`, `precio_unitario`, `stock_disponible`, `stock_minimo`) VALUES
(1, 2, 13, 'Alambre de cobre para bobinado', 0.00, 0, 0),
(2, 2, 2, 'Manguera de Combustible Universal', 0.00, 0, 0),
(3, 2, 3, 'Cable Eléctrico 18 AWG', 0.00, 0, 0),
(4, 1, 4, 'Aceite de Motor 20W50', 0.00, 0, 0),
(5, 4, 5, 'Pastillas de Freno Delanteras', 0.00, 0, 0),
(6, 2, 6, 'Cinta Aislante Eléctrica', 0.00, 0, 0),
(7, 2, 7, 'Soldadura de Estaño y Plomo 60/40', 0.00, 0, 0),
(8, 4, 8, 'Líquido de Frenos DOT 4', 0.00, 0, 0),
(9, 7, 9, 'Pistón Estándar', 0.00, 0, 0),
(10, 1, 10, 'Retén de Aceite de Suspensión Delantera', 0.00, 0, 0);
...
CREATE TABLE `insumos_usados_en_servicio` (
  ...
  `precio_unitario_registrado` decimal(10,2) NOT NULL DEFAULT 0.00
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `insumos_usados_en_servicio` (`id_insumos_orden`, `id_orden`, `id_insumo`, `cantidad`, `precio_unitario_registrado`) VALUES
(1, 1, 1, 2, 0.00),
(2, 1, 3, 10, 0.00),
(3, 1, 6, 1, 0.00),
(4, 1, 7, 5, 0.00),
...
(3, 'ETY 45P', 2, 32145.00, 4),
(4, 'URT 48M', 2, 50205.00, 9),
(5, 'LRT 64K', 4, 128900.00, 10),
(6, 'MNQ 90D', 5, 225000.00, 4),
(7, 'ABC 01E', 6, 8903.00, 9),
(8, 'DEF 02F', 1, 185000.00, 8),
(9, 'GHI 03G', 2, 3000.00, 11),
(10, 'JKL 04H', 1, 452108.00, 12),
...
INSERT INTO `ordenes_de_servicio` (`id_orden`, `id_moto`, `id_usuario`, `id_tecnico_asignado`, `id_tipo_servicio`, `id_estado_de_servicio`, `fecha_de_creacion`, `fecha_finalizacion_estimada`, `descripcion_del_problema`, `fecha_finalizacion`) VALUES
(1, 1, 2, '5', 2, 1, '2025-10-11', '2025-10-16 00:00:00', 'A veces la batería se descarga\n muy rápido.', '2026-08-30 19:31:08'),
(2, 2, 3, '6', 1, 2, '2025-07-11', '2025-08-11 00:00:00', 'Al cambiar de segunda a tercera siento un golpe \n fuerte en la caja', '2026-08-30 19:31:08'),
(3, 3, 4, '25', 3, 5, '2025-06-12', '2025-06-20 00:00:00', 'la moto se recalienta y se enciende el testigo de temperatura', '2026-08-30 19:31:08'),
(4, 4, 9, '7', 4, 3, '2025-10-11', '2025-10-11 00:00:00', 'La motocicleta no enciende, el motor de arranque \ngira con lentitud y se escucha un clic repetitivo al intentar arrancar.', '2026-08-30 19:31:08'),
(5, 5, 10, '7', 5, 5, '2025-10-20', '0000-00-00 00:00:00', 'La motocicleta presenta una inestabilidad \n severa al tomar curvas, se siente flotante o rebota excesivamente después de pasar por baches.', '2026-08-30 19:31:08'),
(6, 6, 4, '13', 6, 1, '2025-11-30', '0000-00-00 00:00:00', 'Se detecta un bajo rendimiento general en la frenada\n , con una distancia de detención más larga de lo normal.', '2026-08-30 19:31:08'),
(7, 7, 9, '5', 7, 4, '2025-12-01', '0000-00-00 00:00:00', 'Se detecta un bajo rendimiento general en la frenada\n , con una distancia de detención más larga de lo normal. El cliente reporta que la motocicleta estuvo detenida por un\n período prolongado (más de ', '2026-08-30 19:31:08'),
(8, 8, 8, '5', 8, 1, '2025-12-01', '2025-12-02 00:00:00', 'El cliente desea instalar un sistema de escape deportivo para mejorar el\n rendimiento y el flujo de gases', '2026-08-30 19:31:08'),
(9, 9, 11, '7', 9, 1, '2025-12-03', '2025-12-03 00:00:00', 'Las llanta delantera de la motocicleta\n se encuentra desalineada con respecto a la llanta trasera', '2026-08-30 19:31:08'),
(10, 10, 12, '13', 10, 5, '2025-12-03', '2025-12-04 00:00:00', 'El interior del motor \ncontiene residuos de polvo', '2026-08-30 19:31:08'),
(12, 22, 1, '5', 1, 4, '2026-06-28', '2026-06-28 00:00:00', 'la moto se recalienta ', '2026-08-30 19:31:08'),
(14, 22, 1, '5', 1, 4, '2026-06-28', '2026-06-28 00:00:00', 'Sin descripción', '2026-08-30 19:31:08'),
(15, 4, 9, '5', 6, 1, '2026-06-28', '2026-06-28 00:00:00', 'espejo derecho roto.', '2026-08-30 19:31:08'),
(16, 4, 9, '27', 4, 5, '2026-06-29', '2026-06-29 00:00:00', 'cadena suelta.', '2026-08-30 19:31:08'),
(18, 26, 28, '27', 1, 2, '2026-07-02', '2026-07-02 00:00:00', 'La batería se descarga muy rápido.', '2026-08-30 19:31:08');
...
CREATE TABLE `registro_actividad` (
  ...
  `id_orden` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `estado_disponibilidad` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `unidad_de_medida` (`id_unidad`, `nombre`, `estado`) VALUES
(1, 'kilogramo(s)', 1),
(2, 'centrimetro(s)', 1),
(3, 'metro(s)', 1),
(4, 'galon(es)', 1),
...
(1, 'Juan', 'Pérez', 'juanperez@gmail.com', '321242892', '$2b$10$/lFCL4Z3guXHD5vgStbhzOcReQjH3iIcWahbNDxAWQy7ZWoyne67G', 1, 1, NULL, NULL),
...
ALTER TABLE `categoria`
  ...
  ADD UNIQUE KEY `cat_nombre` (`nombre`);
...
ALTER TABLE `clasificacion_de_usuarios`
  ...
  ADD UNIQUE KEY `usr_categoria_usuario` (`categoria_usuario`);
...
ALTER TABLE `estado_de_orden_de_servicio`
  ...
  ADD UNIQUE KEY `est_nombre_estado` (`nombre_estado`);
...
ALTER TABLE `imagenes_danos`
  ...
  ADD KEY `fk_imagenes_orden` (`id_orden`);
...
ALTER TABLE `insumos`
  ...
  ADD UNIQUE KEY `ins_nom` (`nombre_insumo`),
...
ALTER TABLE `modelo`
  ...
  ADD UNIQUE KEY `nom_modelo` (`nombre`);
...
ALTER TABLE `registro_actividad`
  ...
  ADD UNIQUE KEY `estd_disponibilidad` (`estado_disponibilidad`),
...
ALTER TABLE `tipo_servicio`
  ...
  ADD UNIQUE KEY `nom_serv` (`nombre_servicio`);
...
ALTER TABLE `unidad_de_medida`
  ...
  ADD UNIQUE KEY `nom_unidad_med` (`nombre`);
...
--
ALTER TABLE `imagenes_danos`
  ADD CONSTRAINT `fk_imagenes_orden` FOREIGN KEY (`id_orden`) REFERENCES `ordenes_de_servicio` (`id_orden`);
...
ALTER TABLE `motocicleta`
  ...
  ADD CONSTRAINT `fk_motocicleta_modelo` FOREIGN KEY (`id_modelo`) REFERENCES `modelo` (`id_modelo`) ON UPDATE CASCADE;
...
--
ALTER TABLE `registro_actividad`
  ADD CONSTRAINT `fk_registro_orden` FOREIGN KEY (`id_orden`) REFERENCES `ordenes_de_servicio` (`id_orden`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_registro_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `usuarios`
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_usuarios_clasificacion` FOREIGN KEY (`id_tipo_usuario`) REFERENCES `clasificacion_de_usuarios` (`id_tipo_usuario`) ON UPDATE CASCADE;
COMMIT;
